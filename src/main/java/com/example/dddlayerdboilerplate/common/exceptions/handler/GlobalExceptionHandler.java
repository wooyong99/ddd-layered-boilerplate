package com.example.dddlayerdboilerplate.common.exceptions.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseDto<?> handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException e) {
        ...
        return ResponseDto.fail(new BaseException(ErrorCode.UNSUPPORTED_MEDIA_TYPE));
    }
    ...
    public ResponseDto<?> handleNoHandlerFoundException(NoHandlerFoundException e) {
        ...
        return ResponseDto.fail(new BaseException(ErrorCode.METHOD_NOT_ALLOWED));
    }
    ...
    public ResponseDto<?> handleException(Exception e) {
        ...
        e.printStackTrace();
        return ResponseDto.fail(new BaseException(ErrorCode.INTERNAL_SERVER_ERROR));
    }
}
